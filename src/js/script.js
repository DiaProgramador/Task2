const bannerItems =[
{
    imagem:"./src/assets/Slideshow_Homemdeferro.png",
    titulo: "Fantasia do Homem de Ferro",
    descricao: "Tecnologia, Estilo e Poder"
},
{
    imagem:"./src/assets/Slideshow_Capitaoamerica.png",
    titulo: "Fantasia do Capitão América",
    descricao: "Clássica. Icônica. Inconfundível."
},

{
    imagem:"./src/assets/Slideshow_Homemaranha.png",
    titulo: "Fantasia do Homem-Aranha",
    descricao: "Flexível, leve e cheio de estilo"
}
...
const tempo = 6000; // tempo em milissegundos
